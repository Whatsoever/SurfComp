...
#(Problably S1 and S2 can be enclosed in a for loop, reducing lines of code. If I have time and will, I will look at it.)
    ...
    #### plane gamma [diffusive plane]
    Z[pos_psi_S1_vec[3],pos_psi_S1_vec[2]] =Z[pos_psi_S1_vec[3],pos_psi_S1_vec[2]] - CapacitancesS1[2]
    Z[pos_psi_S2_vec[3],pos_psi_S2_vec[2]] =Z[pos_psi_S2_vec[3],pos_psi_S2_vec[2]] - CapacitancesS2[2]
    #
    ew = eo*e
    ...
    y2[1,0] = -(CapacitancesS1[2]*((X[pos_psi_S1_vec[3]]*delta_psi)-Boltzman_factor_2_psi(X[pos_psi_S1_vec[2]], temp)))/ew
    ...
    d_sigma_d_psi_S1= (ew/(delta_psi*X[pos_psi_S1_vec[3]]))*(result1.y[1,0]-result0.y[1, 0])
    d_sigma_d_psi_S2= (ew/(delta_psi*X[pos_psi_S1_vec[2]]))*(result2.y[1,-1]-result0.y[1, -1])
